...
@DisplayName("MoneyMovementToTransactionStatusATMConverter tests ")
class MoneyMovementToTransactionStatusATMConverterTest {
    ...
    @InjectMocks
    private MoneyMovementToTransactionStatusATMConverter converter;
